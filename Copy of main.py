...
class MainPage(Handler):
	...
	def post(self):
		...
		#page_image = self.request.get('page_image')		#TODO verify
		...
		values = {'secret': "6LdFmiEUAAAAAFfXHgkzzcmJo7jkB2Pc5ytwBewO", 'response': recaptcha_response}
